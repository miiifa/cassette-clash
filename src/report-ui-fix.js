...
function planz(pl){return pl?{t:pl.type,p:pz(pl.piece||pl.p),to:pl.to||pl.n||null,d:pz(pl.defender||pl.d),s:pl.score==null?null:Math.round(pl.score),f:fz(pl.features),why:pl.why||pl.reasons||null,surround:pl.surround||null}:null;}
...
function slimEvent(e){
  ...
  if(e.type==='ai_guard_surround_rescue')return {...base,chosen:d.chosen,danger:d.danger};
  if(e.type==='ai_guard_surround_emergency'||e.type==='ai_guard_surround_no_good_block')return {...base,chosen:d.chosen||d.candidate,enemyThreats:d.enemyThreats,used:e.type==='ai_guard_surround_emergency'};
